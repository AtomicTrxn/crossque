// app_theme.dart
// Drop into lib/core/theme/app_theme.dart
// Provides light + dark ThemeData seeded from Crosscue brand blue.
...
abstract class AppTheme {
  ...
  static ThemeData _build(ColorScheme scheme) {
    ...
    return ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          ...
          return TextStyle(
            ...
            color: active ? scheme.primary : (isLight
      ...
      dividerColor: isLight ? CrosscueColors.dividerLight : CrosscueColors.dividerDark,
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: TextStyle(
          fontSize: CrosscueTypography.bodySmall,
          fontWeight: FontWeight.w400,
          color: isLight ? CrosscueColors.onSurface3Light : CrosscueColors.onSurface3Dark,
        ),
        shape: RoundedRectangleBorder(
      ...
      textTheme: TextTheme(
        ...
        bodySmall: TextStyle(
          fontFamily: CrosscueTypography.roboto,
          fontSize: CrosscueTypography.bodySmall,
          color: isLight ? CrosscueColors.onSurface2Light : CrosscueColors.onSurface2Dark,
        ),
...
/// Helper to build a TimerTextStyle anywhere in the app.
